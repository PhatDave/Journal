...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.reminderList.setGeometry(QRect(600, 640, 600, 360))
        ...
        self.reminderList.setFont(font1)
        ...
        self.markdownPreview.setGeometry(QRect(0, 640, 600, 360))
        ...
        self.markdownPreview.setMinimumSize(QSize(600, 360))
        self.markdownPreview.setMaximumSize(QSize(600, 360))
        self.markdownPreview.setFont(font1)
